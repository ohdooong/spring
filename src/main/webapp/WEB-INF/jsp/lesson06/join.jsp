	...
	<div class="container">
		...
		<div class="form-group">
			...
			<div class="d-flex">
				...
				<button type="button" id="nameCheckBtn" class="btn btn-primary ml-2">중복확인</button>
			</div>
...
<script>
	$(document).ready(function() {
		...
		$('#nameCheckBtn').on("click", function(e) {
			...
			$.ajax({
				// request
				type:"GET"  // 생략가능 기본값이 GET방식
				,url:"/lesson06/ex02/is-duplication"
				,data:{"name":name}
								
				// response
				, success: function(data) {   // data => String 	OR 		Json : 변환된 Dictionary
